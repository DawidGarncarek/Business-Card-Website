...
<body onload="odliczanie()">
    ...
    <section class="slogan">
        <div class="bg">
            ...
            <p class="text">"Nie lubię pracy – nikt jej nie lubi – ale lubię to, co jest w pracy: możliwość znalezienia siebie. Twoja własna rzeczywistość – dla ciebie, a nie dla innych – czego nikt nigdy się nie dowie"</p>
