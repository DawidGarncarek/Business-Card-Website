    ...
    <section class="menu clearfix">
        <nav>
            <ul class="menu clearfix">
                ...
                <li><a href="#kontakt"><i class="fa-solid fa-desktop"></i>Kontakt</a></li>
            </ul>
        </nav>
    </section>
    <section class="hobby clearfix" id="three">
        <h1>Moje główne zainteresowania</h1>
        <div class="item">
            <p>Uwielbiam uprawiać sport</p>
        </div>
        <div class="item">
            <p>Interesuję się kinematografią</p>
        </div>
        <div class="item">
            <p>Podróżować w ciekawe miejsca</p>
        </div>
        <div class="item">
            <p>Poznawać nowinki technologiczne</p>
        </div>
    </section>
